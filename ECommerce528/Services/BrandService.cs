    ...
    public class BrandService
    {
        ...
        public string? SaveImg(IFormFile logo)
        {
            try
            {
                ...
                var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\images\\brand_logo", fileName);
        ...
        public bool RemoveImg(string logoName)
        {
            try
            {
                var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\images\\brand_logo", logoName);
